...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      brownie.add_ingredient("flour") do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      brownie.mix! do
        ...
        expect brownie.ingredients.to not_eq(["chocolate", "flour", "eggs", "sugar"])
      end
    end
  end
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect{brownie.eat(1000).to raise_error(ArgumentError)}
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(brownie.serve).to eq("Chef Jimmy the Great Baker has made 100 brownies!")
    end
  end
